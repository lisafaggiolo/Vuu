...
City.create(name: "Okanagan Valley", province: "British Columbia", population: 362258, local temperature:)
City.create(name: "North Vancouver", province: "British Columbia", population: 85935, local temperature:)
City.create(name: "Kelowna", province:"British Columbia", population: 194882, local temperature:)
City.create(name: "Gaspe", province: "Quebec", population: 15163, local temperature:)
City.create(name: "Iles de la Madeleine", province: "Quebec", population: 12010, local temperature:)
City.create(name: "Perce", province: "Quebec" population: 3103, local temperature:)
City.create(name: "Wasaga Beach", province: "Ontario", population: 20675, local temperature:)
City.create(name: "Collingwood", province: "Ontario", population: 21793, local temperature:)
City.create(name: "Jasper" province: "Alberta", population: 4590,  local temperature:)
City.create(name: "Banff", province: "Alberta", population: 7847, local temperature:)
City.create(name: "Halifax", province: "Nova Scotia", population: 431479, local temperature:)
City.create(name: "Charlottetown", province: "Prince Edward Island", population: 36094, local temperature:)
City.create(name: "St-Johns" province: "Newfoundland and Labrador", population: 113948,  local temperature:)
City.create(name: "Moncton" province: "New Brunswick", population: 85198, local temperature:)
City.create(name: "White Horse" province: "Yukon", population: 25085,  local temperature:)
City.create(name: "Winnepeg" province: "Manitoba", population: 749534, local temperature:)
City.create(name: "Iqaluit" province: "Nunavut", population: 7740, local temperature:)
City.create(name: "Meadow Lake" province: "Saskatchewan", population: 5344 local temperature:)
City.create(name: "Gander" province: "Newfoundland and Labrador", population: 11688, local temperature:)
