...
City.create(name: "Okanagan Valley", province: "British Columbia", population: local temperature:)
City.create(name: "North Vancouver", province: "British Columbia", population: local temperature:)
City.create(name: "Kelowna", province:"British Columbia", population: local temperature:)
City.create(name: "Gaspe", province: "Quebec", population: local temperature:)
City.create(name: "Iles de la Madeleine", province: "Quebec", population: local temperature:)
City.create(name: "Perce", province: "Quebec" population: local temperature:)
City.create(name: "Wasaga Beach", province: "Ontario", population: local temperature:)
City.create(name: "Collingwood", province: "Ontario", population: local temperature:)
City.create(name: "Jasper" province: "Alberta", population: local temperature:)
City.create(name: "Banff", province: "Alberta", population: local temperature:)
City.create(name: "Halifax", province: "Nova Scotia", population: local temperature:)
City.create(name: "Charlottetown", province: "Prince Edward Island", population: local temperature:)
City.create(name: "St-Johns" province: "Newfoundland and Labrador", population: local temperature:)
City.create(name: "Moncton" province: "New Brunswick", population: local temperature:)
City.create(name: "White Horse" province: "Yukon", population: local temperature:)
City.create(name: "Winnepeg" province: "Manitoba", population: local temperature:)
City.create(name: "Iqaluit" province: "Nunavut", population: local temperature:)
City.create(name: "Meadow Lake" province: "Saskatchewan", population: local temperature:)
City.create(name: "Gander" province: "Newfoundland and Labrador", population: local temperature:)
