...
City.create(name: "Okanagan Valley", province_id: 10,  image: '/images/10-BC/oka.jpg', population: 362258, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "V1T%207J3", pollution_index: 0)

City.create(name: "Vancouver", province_id: 10,  image: '/images/10-BC/vanc.png', population: 2463431, 
            ...
            healthcare_index: 75.37, crime_index: 36.73, postal_code: "V6C%200A8", pollution_index: 23.85)
...
City.create(name: "Gaspe Peninsula", province_id: 5,  image: '/images/5-QC/Rocher-Perce.jpg', population: 15163, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "G0E%201W0", pollution_index: 0)
...
City.create(name: "Magdalen Islands", province_id: 5,  image: '/images/5-QC/Magdalen-picture.jpg', population: 12010, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "G4T%209C4", pollution_index: 0)

City.create(name: "Wasaga Beach", province_id: 6,  image: '/images/6-ON/was.jpg', population: 20675, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "L9Z%202X1", pollution_index: 0)

City.create(name: "Strathcona County", province_id: 9,  image: '/images/9-AB/strath.jpg', population: 98044, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "T8E%202A1", pollution_index: 0)

City.create(name: "Jasper", province_id: 9, image: '/images/9-AB/jasp.jpg', population: 4590,  
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "T0E%201V0", pollution_index: 0)

City.create(name: "Banff", province_id: 9,  image: '/images/9-AB/ban.jpg', population: 7847, 
            ...
            location_type: "town", view_type: ["mountain", "lake"], time_zone: "MDT", 
            healthcare_index: 0, crime_index: 0, postal_code: "T1L%200A1", pollution_index: 0)
...
City.create(name: "Halifax", province_id: 3,  image: '/images/3-NS/1-Halifax.jpg', population: 431479, 
            ...
            healthcare_index: 69.60, crime_index: 40.36, postal_code: "B3H%200B1", pollution_index: 22.57)
...
City.create(name: "Charlottetown", province_id: 2,  image: '/images/2-PEI/2-Charlottetown.jpg', population: 36094, 
            ...
            healthcare_index: 50.69, crime_index: 34.14, postal_code: "C1A%200A9", pollution_index: 5.69)
...
City.create(name: "St-Johns", province_id: 1, image: '/images/1-NFLD/1-St-Johns.jpg', population: 113948,
            ...
            healthcare_index: 64.01, crime_index: 47.61, postal_code: "A1A%200A4", pollution_index: 22.95)
...
City.create(name: "Moncton", province_id: 4,  image: '/images/4-NB/1-Moncton.jpg', population: 85198, 
            ...
            healthcare_index: 77.14, crime_index: 40.90, postal_code: "E1A%200C6", pollution_index: 16.89)
...
City.create(name: "Whitehorse", province_id: 11,  image: '/images/', population: 25085,
            ...
            healthcare_index: 79.17, crime_index: 45.20, postal_code: "Y1A%200A4", pollution_index: 12.96)

City.create(name: "Winnipeg", province_id: 7,  image: '/images/7-MB/win.jpeg', population: 749534, 
            ...
            healthcare_index: 68.82, crime_index: 57.02, postal_code: "R2C%200A8", pollution_index: 36.68)
...
City.create(name: "Iqaluit", province_id: 13,  image: '/images/13-NV/iq.jpg', population: 7740, 
            ...
            healthcare_index: 63.89, crime_index:	48.82, postal_code: "X0A%200H0", pollution_index: 60.78)
...
City.create(name: "Massif de Charlevoix", province_id: 5, image: '/images/5-QC/mdc.jpg', population: 29562, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "G0A%202L0", pollution_index: 0)
...
City.create(name: "Quebec City", province_id: 5,  image: '/images/5-QC/qc.jpg', population: 542298, 
            ...
            healthcare_index: 71.45, crime_index: 14.74, postal_code: "G1A%201A1", pollution_index: 31.94)
...
City.create(name: "Montreal", province_id: 5,  image: '/images/5-QC/mont.jpg', population: 1780000, 
            ...
            location_type: "city-large", view_type: ["urban"], time_zone: "EDT",
            healthcare_index: 64.43, crime_index: 29.18, postal_code: "H2J%202L1", pollution_index: 33.29)
...
City.create(name: "Toronto", province_id: 6,  image: '/images/6-ON/tor.jpg', population: 2930000, 
            ...
            location_type: "city-large", view_type: ["urban"], time_zone: "EDT",
            healthcare_index: 75.87, crime_index: 39.41, postal_code: "M1W%202E7", pollution_index: 37.88)
...
City.create(name: "Ottawa", province_id: 6,  image: '/images/6-ON/ott.jpg', population: 994837, 
            ...
            location_type: "city-large", view_type: ["urban"], time_zone: "EDT",
            healthcare_index: 75.34, crime_index: 26.07, postal_code: "K1G%208J5", pollution_index: 20.36)
...
City.create(name: "Victoria", province_id: 10,  image: '/images/10-BC/vic.jpg', population: 92141, 
            ...
            healthcare_index: 70.09, crime_index: 34.51, postal_code: "V8P%204J4", pollution_index: 15.46)
...
City.create(name: "Tofino", province_id: 10,  image: '/images/10-BC/tof.jpg', population: 1932, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "V0R%202Z0", pollution_index: 0)
...
City.create(name: "Canmore", province_id: 9,  image: '/images/9-AB/canmore.jpg', population: 13992, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "T1W%200A8", pollution_index: 0)
...
City.create(name: "Calgary", province_id: 9,  image: '/images/9-AB/calg.jpg', population: 1336000, 
            ...
            healthcare_index: 76.74, crime_index: 34.15, postal_code: "T1Y%207T5", pollution_index: 24.87)
...
City.create(name: "The Thousand Islands", province_id: 6,  image: '/images/6-ON/thou.jpg', population: 9465, 
            ...
            location_type: "town", view_type: ["lake"], time_zone: "EDT",
            healthcare_index: 0, crime_index: 0, postal_code: "K7G%202M2", pollution_index: 0)
...
City.create(name: "Niagara", province_id: 6,  image: '/images/6-ON/niag.jpg', population: 447888, 
            ...
            healthcare_index: 73.33, crime_index: 32.98, postal_code: "L2E%201A2", pollution_index: 27.68)
...
City.create(name: "Regina", province_id: 8,  image: '/images/8-SK/reg.jpg', population: 228928, 
            ...
            healthcare_index: 68.75, crime_index: 54.60, postal_code: "S0G%203W0", pollution_index: 39.13)
...
City.create(name: "Saskatoon", province_id: 8,  image: '/images/8-SK/sask.jpg', population: 273010, 
            ...
            healthcare_index: 63.97, crime_index: 49.47, postal_code: "S0K%200Y0", pollution_index: 27.9)
...
City.create(name: "Moose Jaw", province_id: 8,  image: '/images/8-SK/mj.jpg', population: 33890, 
            ...
            healthcare_index: 68.98, crime_index: 48.53, postal_code: "S0H%200N0", pollution_index: 22.13)
...
City.create(name: "Swift Current", province_id: 8,  image: '/images/8-SK/swift.jpg', population: 16604, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "S9H%200A5", pollution_index: 0)
...
City.create(name: "Prince Albert", province_id: 8,  image: '/images/8-SK/prince_albert.jpg', population: 35926, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "S6V%200A4", pollution_index: 0)
...
City.create(name: "Brandon", province_id: 7,  image: '/images/7-MB/brandon.jpg', population: 48859, 
            ...
            location_type: "city-small", view_type: ["river"], time_zone: "CST",
            healthcare_index: 71.94, crime_index: 43.46, postal_code: "R0K%200R0", pollution_index: 35.63)
...
City.create(name: "Portage la Prairie", province_id: 7,  image: '/images/7-MB/plp.jpg', population: 13304, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "R0H%201N1", pollution_index: 0)
...
City.create(name: "Dauphin", province_id: 7,  image: '/images/7-MB/dauphin.jpg', population: 8457, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "R7N%200A4", pollution_index: 0)
...
City.create(name: "Gimli", province_id: 7,  image: '/images/7-MB/gimli.jpg', population: 2246, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "R0C%201B0", pollution_index: 0)
...
City.create(name: "Fredericton", province_id: 4,  image: '/images/4-NB/2-Fredericton.jpg', population: 58220, 
            ...
            healthcare_index: 52.45, crime_index: 29.87, postal_code: "E3A%200E2", pollution_index: 18.47)
...
City.create(name: "Saint John", province_id: 4,  image: '/images/4-NB/3-Saint-John.jpg', population: 67575, 
            ...
            location_type: "city-small", view_type: ["river"], time_zone: "AST",
            healthcare_index: 76.65, crime_index: 35.10, postal_code: "E2H%201A4", pollution_index: 66.59)
...
City.create(name: "Saint Andrews", province_id: 4,  image: '/images/4-NB/4-Saint-Answers.jpg', population: 1786, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "E5B%201A2", pollution_index: 0)
...
City.create(name: "Grand Falls", province_id: 4,  image: '/images/', population: 5326, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "A2A%200A9", pollution_index: 0)
...
City.create(name: "Lunenburg", province_id: 3,  image: '/images/3-NS/2-Lunenburg.jpg', population: 2263, 
            ...
            location_type: "village", view_type: ["coast"], time_zone: "AST",
            healthcare_index: 0, crime_index: 0, postal_code: "B0J%202C0", pollution_index: 0)
...
City.create(name: "Baddeck", province_id: 3,  image: '/images/3-NS/3-Baddeck.jpg', population: 769, 
            ...
            location_type: "village", view_type: ["coast"], time_zone: "AST",
            healthcare_index: 0, crime_index: 0, postal_code: "B0E%201B0", pollution_index: 0)
...
City.create(name: "Sydney", province_id: 3,  image: '/images/3-NS/4-Sydney.jpg', population: 29904, 
            ...
            healthcare_index: 61.11, crime_index: 37.22, postal_code: "B1N%201A1", pollution_index: 10.34)
...
City.create(name: "Dartmouth", province_id: 3,  image: '/images/3-NS/5-Darthmouth.jpg', population: 65741, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "B0J%203A0", pollution_index: 0)
...
City.create(name: "Cavendish", province_id: 2,  image: '/images/2-PEI/2-Cavendish.jpg', population: 7500, 
            ...
            location_type: "town", view_type: ["coast"], time_zone: "AST",
            healthcare_index: 0, crime_index: 0, postal_code: "C0A%201M0", pollution_index: 0)
...
City.create(name: "Corner Brook", province_id: 1,  image: '/images/1-NFLD/2-Corner_Brook.jpg', population: 19806, 
            ...
            healthcare_index: 0, crime_index: 28.68, postal_code: "A2H%200A4", pollution_index: 5.60)
...
City.create(name: "Deer Lake", province_id: 1,  image: '/images/1-NFLD/3-Deer_lake.jpg', population: 5249, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "A8A%200B1", pollution_index: 0)
...
City.create(name: "Gander", province_id: 1,  image: '/images/1-NFLD/4-Gander.jpg', population: 11688, 
            ...
            location_type: "town", view_type: ["lake"], time_zone: "NDT",
            healthcare_index: 0, crime_index: 0, postal_code: "A0G%201C0", pollution_index: 0)
...
City.create(name: "Twillingate", province_id: 1,  image: '/images/1-NFLD/5-Twillingate.jpg', population: 2196, 
            ...
            healthcare_index: 0, crime_index: 0, postal_code: "A0G%201Y0", pollution_index: 0)
...
City.create(name: "Yellowknife", province_id: 12,  image: '/images/', population: 19569, 
            ...
            healthcare_index: 88.74, crime_index: 56.06, postal_code: "X1A%200A7", pollution_index: 28.45)